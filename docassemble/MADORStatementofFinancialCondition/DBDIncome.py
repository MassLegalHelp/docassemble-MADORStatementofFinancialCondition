...
def non_wage_income_list():
    ...
    type_list.gathered = True
    type_list.elements.update([
        ('commissions', 'Commissions, Bonuses, Tips'),
...
def expense_type_list_ma_dor() :
    ...
    type_list.elements.update([
        ...
        ('homeinsurance', 'Renter or homeowner insurance'),
        ('water', 'Water, or Water and sewer')
        ('electricity', 'Electricity'),
        ('gas', 'Gas'),
        ('heat', 'Heat that is not gas or electric'),
        ('cellphone', 'Cell phone'),
        ('landline'), 'Landline telephone'
        ('groceries', 'Groceries'),
        ('clothing', 'Clothing'),
        ('lifeinsurance', 'Life Insurance'),
        ('autoinsurance', 'Car Insurance'),        
        ('support', 'Child support for other children'),
        ('alimony', 'Alimony'),      
        ('transportation', 'Transportation'),
        ('medicalinsurance', 'Medical insurance')
        ('medical', 'Medical or dental expenses that insurance does not cover)'),
